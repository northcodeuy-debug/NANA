 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gg;function Rx(){return Gg||(Gg=1,(function(o){function e(O,Z){var q=O.length;O.push(Z);t:for(;0<q;){var xt=q-1>>>1,D=O[xt];if(0<l(D,Z))O[xt]=Z,O[q]=D,q=xt;else break t}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var Z=O[0],q=O.pop();if(q!==Z){O[0]=q;t:for(var xt=0,D=O.length,J=D>>>1;xt<J;){var vt=2*(xt+1)-1,St=O[vt],Dt=vt+1,Ft=O[Dt];if(0>l(St,q))Dt<D&&0>l(Ft,St)?(O[xt]=Ft,O[Dt]=q,xt=Dt):(O[xt]=St,O[vt]=q,xt=vt);else if(Dt<D&&0>l(Ft,q))O[xt]=Ft,O[Dt]=q,xt=Dt;else break t}}return Z}function l(O,Z){var q=O.sortIndex-Z.sortIndex;return q!==0?q:O.id-Z.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,v=null,S=3,y=!1,A=!1,R=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function U(O){for(var Z=i(p);Z!==null;){if(Z.callback===null)r(p);else if(Z.startTime<=O)r(p),Z.sortIndex=Z.expirationTime,e(m,Z);else break;Z=i(p)}}function z(O){if(R=!1,U(O),!A)if(i(m)!==null)A=!0,G||(G=!0,nt());else{var Z=i(p);Z!==null&&lt(z,Z.startTime-O)}}var G=!1,F=-1,j=5,w=-1;function C(){return M?!0:!(o.unstable_now()-w<j)}function V(){if(M=!1,G){var O=o.unstable_now();w=O;var Z=!0;try{t:{A=!1,R&&(R=!1,I(F),F=-1),y=!0;var q=S;try{e:{for(U(O),v=i(m);v!==null&&!(v.expirationTime>O&&C());){var xt=v.callback;if(typeof xt=="function"){v.callback=null,S=v.priorityLevel;var D=xt(v.expirationTime<=O);if(O=o.unstable_now(),typeof D=="function"){v.callback=D,U(O),Z=!0;break e}v===i(m)&&r(m),U(O)}else r(m);v=i(m)}if(v!==null)Z=!0;else{var J=i(p);J!==null&&lt(z,J.startTime-O),Z=!1}}break t}finally{v=null,S=q,y=!1}Z=void 0}}finally{Z?nt():G=!1}}}var nt;if(typeof P=="function")nt=function(){P(V)};else if(typeof MessageChannel<"u"){var ut=new MessageChannel,_t=ut.port2;ut.port1.onmessage=V,nt=function(){_t.postMessage(null)}}else nt=function(){_(V,0)};function lt(O,Z){F=_(function(){O(o.unstable_now())},Z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return S},o.unstable_next=function(O){switch(S){case 1:case 2:case 3:var Z=3;break;default:Z=S}var q=S;S=Z;try{return O()}finally{S=q}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(O,Z){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var q=S;S=O;try{return Z()}finally{S=q}},o.unstable_scheduleCallback=function(O,Z,q){var xt=o.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?xt+q:xt):q=xt,O){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=q+D,O={id:g++,callback:Z,priorityLevel:O,startTime:q,expirationTime:D,sortIndex:-1},q>xt?(O.sortIndex=q,e(p,O),i(m)===null&&O===i(p)&&(R?(I(F),F=-1):R=!0,lt(z,q-xt))):(O.sortIndex=D,e(m,O),A||y||(A=!0,G||(G=!0,nt()))),O},o.unstable_shouldYield=C,o.unstable_wrapCallback=function(O){var Z=S;return function(){var q=S;S=Z;try{return O.apply(this,arguments)}finally{S=q}}}})(Df)),Df}var Vg;function Cx(){return Vg||(Vg=1,wf.exports=Rx()),wf.exports}var Uf={exports:{}},bn={};/**
 * @license React
